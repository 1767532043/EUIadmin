  ...
  <div>
    <div style="float: left">
      <i
        ...
        :style="{
          color: web_setting.head_icon_color,
          padding: '20px',
          cursor: 'pointer',
        }"
      />
      <el-input
        ...
        @change="search()"
        size="small"
        style="float: right; width: 200px; padding-top: 15px"
      ></el-input>
    </div>
    <el-menu
      class="el-menu-demo"
      mode="horizontal"
      :background-color="web_setting.head_background_color"
      :text-color="web_setting.head_text_color"
      :active-text-color="web_setting.head_active_text_color"
      :style="{ float: 'right' }"
    >
      <el-menu-item index="3" @click="message()">
        <i class="el-icon-bell" :style="{ color: web_setting.head_icon_color }" />
      ...
      <el-menu-item index="2" @click="change_full_screen">
        <template slot="title">
          <i
            ...
            :style="{ color: web_setting.head_icon_color }"
          />
        </template>
      </el-menu-item>
      <el-submenu index="4">
...
export default {
  ...
  methods: {
    change_aside_state() {//左侧菜单控制
      ...
      this.$emit("aside_state", this.aside_state);
    },
    message() {//点击信息按钮时跳转
